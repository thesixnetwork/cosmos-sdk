...
func TestValidateGenesisMultipleMessages(t *testing.T) {
	...
	msg1, err := stakingtypes.NewMsgCreateValidator(sdk.ValAddress(pk1.Address()), "approver", pk1,
		sdk.NewInt64Coin(sdk.DefaultBondDenom, 50), desc, comm, sdk.OneInt())
	require.NoError(t, err)

	msg2, err := stakingtypes.NewMsgCreateValidator(sdk.ValAddress(pk2.Address()), "approver", pk2,
		sdk.NewInt64Coin(sdk.DefaultBondDenom, 50), desc, comm, sdk.OneInt())
	require.NoError(t, err)
...
func TestValidateGenesisBadMessage(t *testing.T) {
	...
	msg1 := stakingtypes.NewMsgEditValidator(sdk.ValAddress(pk1.Address()), desc, nil, nil, sdk.Int{}, false ,false)
