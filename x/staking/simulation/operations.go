...
func SimulateMsgCreateValidator(
	...
	return func(
		...
		msg, err := types.NewMsgCreateValidator(address.String(), address.String(), simAccount.ConsKey.PubKey(), selfDelegation, description, commission, math.OneInt())
		if err != nil {
...
func SimulateMsgEditValidator(
	...
	return func(
		...
		msg := types.NewMsgEditValidator(address, description, &newCommissionRate, nil, "", &math.Int{}, nil, nil)
