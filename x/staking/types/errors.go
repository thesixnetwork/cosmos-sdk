...
var (
	...
	ErrEmptyApproverAddr               = errors.Register(ModuleName, 46, "empty validator approver public key")
	...
	ErrLicenseIncrement                = errors.Register(ModuleName, 51, "In license mode, Min Delegation and DelegationIncrement must be defined and positive")
	...
	ErrLicenseLimit                    = errors.Register(ModuleName, 54, "license limit has reached its  maximum")
	ErrNotEnoughLicense                = errors.Register(ModuleName, 55, "There is no license enough for the delegation")
	ErrRedelegationDisable             = errors.Register(ModuleName, 56, "Redelegation is disable for this/these validator(s)")
	ErrSpecialModeDisable              = errors.Register(ModuleName, 57, "SpecialMode is disable for this/these validator(s)")
	...
	ErrNewMinimumDelegationInvalid     = errors.Register(ModuleName, 63, "New minimum delegation must respect current delegator amount")
)
