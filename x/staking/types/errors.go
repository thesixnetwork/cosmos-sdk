...
var (
	...
	ErrEmptyApproverAddr               = errors.Register(ModuleName, 40, "empty validator approver public key")
	ErrEmptyNewApproverAddr            = errors.Register(ModuleName, 41, "empty new validator approver public key")
	ErrNoValidatorApprovalFound        = errors.Register(ModuleName, 42, "validator approval does not exist")
	ErrMaxLicenseMustBeDefined         = errors.Register(ModuleName, 43, "when on license mode, max_license must be defined")
	ErrMaxLicenseMustBeGeater          = errors.Register(ModuleName, 44, "max license must be greater than or equal to the existing one")
	ErrLicenseIncrement                = errors.Register(ModuleName, 45, "In license mode, Min Delegation and DelegationIncrement must be defined and the same")
	ErrDelegationBelowMinimum          = errors.Register(ModuleName, 46, "delegation amount less than minimum")
	ErrInvalidIncrementDelegation      = errors.Register(ModuleName, 47, "delegation amount must meet increment condition, 100,200,300,..")
	ErrLicenseLimit                    = errors.Register(ModuleName, 48, "license limit has reached its  maximum")
	ErrNotEnoughLicense                = errors.Register(ModuleName, 49, "There is no license enough for the delegation")
	ErrRedelegationDisable             = errors.Register(ModuleName, 50, "Redelegation is disable for this/these validator(s)")
	ErrSpecialModeDisable              = errors.Register(ModuleName, 51, "SpecialMode is disable for this/these validator(s)")
	ErrDelegatorIsNotSpecial           = errors.Register(ModuleName, 52, "Cannot find delegator in whitelist")
	ErrBadValidatorRequest             = errors.Register(ModuleName, 53, "Did not found delegator in this validator list")
	ErrCommissionLTMinRate             = errors.Register(ModuleName, 55, "commission cannot be less than min rate")
	ErrBadRedelegationNotSpecial       = errors.Register(ModuleName, 54, "redelegation validator is not special node ")
	ErrUnbondingNotFound               = errors.Register(ModuleName, 56, "unbonding operation not found")
	ErrUnbondingOnHoldRefCountNegative = errors.Register(ModuleName, 57, "cannot un-hold unbonding operation that is not on hold")
	ErrInvalidSigner                   = errors.Register(ModuleName, 58, "expected authority account as only signer for proposal message")
	ErrBadRedelegationSrc              = errors.Register(ModuleName, 59, "redelegation source validator not found")
	ErrNoUnbondingType                 = errors.Register(ModuleName, 60, "unbonding type not found")
)
