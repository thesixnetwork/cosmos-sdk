...
const (
	Msg_SetValidatorApproval_FullMethodName      = "/cosmos.staking.v2beta1.Msg/SetValidatorApproval"
	Msg_CreateValidator_FullMethodName           = "/cosmos.staking.v2beta1.Msg/CreateValidator"
	Msg_EditValidator_FullMethodName             = "/cosmos.staking.v2beta1.Msg/EditValidator"
	Msg_Delegate_FullMethodName                  = "/cosmos.staking.v2beta1.Msg/Delegate"
	Msg_BeginRedelegate_FullMethodName           = "/cosmos.staking.v2beta1.Msg/BeginRedelegate"
	Msg_Undelegate_FullMethodName                = "/cosmos.staking.v2beta1.Msg/Undelegate"
	Msg_CreateWhitelistdelegator_FullMethodName  = "/cosmos.staking.v2beta1.Msg/CreateWhitelistdelegator"
	Msg_DeleteWhitelistdelegator_FullMethodName  = "/cosmos.staking.v2beta1.Msg/DeleteWhitelistdelegator"
	Msg_CancelUnbondingDelegation_FullMethodName = "/cosmos.staking.v2beta1.Msg/CancelUnbondingDelegation"
	Msg_UpdateParams_FullMethodName              = "/cosmos.staking.v2beta1.Msg/UpdateParams"
)
