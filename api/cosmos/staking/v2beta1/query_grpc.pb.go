...
const (
	Query_ValidatorApproval_FullMethodName             = "/cosmos.staking.v2beta1.Query/ValidatorApproval"
	Query_Validators_FullMethodName                    = "/cosmos.staking.v2beta1.Query/Validators"
	Query_Validator_FullMethodName                     = "/cosmos.staking.v2beta1.Query/Validator"
	Query_ValidatorDelegations_FullMethodName          = "/cosmos.staking.v2beta1.Query/ValidatorDelegations"
	Query_ValidatorUnbondingDelegations_FullMethodName = "/cosmos.staking.v2beta1.Query/ValidatorUnbondingDelegations"
	Query_Delegation_FullMethodName                    = "/cosmos.staking.v2beta1.Query/Delegation"
	Query_UnbondingDelegation_FullMethodName           = "/cosmos.staking.v2beta1.Query/UnbondingDelegation"
	Query_DelegatorDelegations_FullMethodName          = "/cosmos.staking.v2beta1.Query/DelegatorDelegations"
	Query_DelegatorUnbondingDelegations_FullMethodName = "/cosmos.staking.v2beta1.Query/DelegatorUnbondingDelegations"
	Query_Redelegations_FullMethodName                 = "/cosmos.staking.v2beta1.Query/Redelegations"
	Query_DelegatorValidators_FullMethodName           = "/cosmos.staking.v2beta1.Query/DelegatorValidators"
	Query_DelegatorValidator_FullMethodName            = "/cosmos.staking.v2beta1.Query/DelegatorValidator"
	Query_HistoricalInfo_FullMethodName                = "/cosmos.staking.v2beta1.Query/HistoricalInfo"
	Query_Pool_FullMethodName                          = "/cosmos.staking.v2beta1.Query/Pool"
	Query_Params_FullMethodName                        = "/cosmos.staking.v2beta1.Query/Params"
	Query_Whitelistdelegator_FullMethodName            = "/cosmos.staking.v2beta1.Query/Whitelistdelegator"
	Query_WhitelistdelegatorAll_FullMethodName         = "/cosmos.staking.v2beta1.Query/WhitelistdelegatorAll"
)
...
func (c *queryClient) ValidatorApproval(ctx context.Context, in *QueryValidatorApprovalRequest, opts ...grpc.CallOption) (*QueryValidatorApprovalResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ValidatorApproval_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) ValidatorApproval(context.Context, *QueryValidatorApprovalRequest) (*QueryValidatorApprovalResponse, error) {
...
func _Query_ValidatorApproval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ValidatorApproval_FullMethodName,
	}
