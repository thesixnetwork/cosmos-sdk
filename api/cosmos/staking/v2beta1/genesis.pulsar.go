...
func init() {
	file_cosmos_staking_v2beta1_genesis_proto_init()
	md_GenesisState = File_cosmos_staking_v2beta1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v2beta1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v2beta1.GenesisState.params":
		return x.Params != nil
	case "cosmos.staking.v2beta1.GenesisState.last_total_power":
		return len(x.LastTotalPower) != 0
	case "cosmos.staking.v2beta1.GenesisState.last_validator_powers":
		return len(x.LastValidatorPowers) != 0
	case "cosmos.staking.v2beta1.GenesisState.validator_approval":
		return x.ValidatorApproval != nil
	case "cosmos.staking.v2beta1.GenesisState.validators":
		return len(x.Validators) != 0
	case "cosmos.staking.v2beta1.GenesisState.delegations":
		return len(x.Delegations) != 0
	case "cosmos.staking.v2beta1.GenesisState.unbonding_delegations":
		return len(x.UnbondingDelegations) != 0
	case "cosmos.staking.v2beta1.GenesisState.redelegations":
		return len(x.Redelegations) != 0
	case "cosmos.staking.v2beta1.GenesisState.exported":
		return x.Exported != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v2beta1.GenesisState"))
		}
		panic(fmt.Errorf("message cosmos.staking.v2beta1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v2beta1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v2beta1.GenesisState.redelegations":
		...
		return protoreflect.ValueOfList(value)
	case "cosmos.staking.v2beta1.GenesisState.last_total_power":
		panic(fmt.Errorf("field last_total_power of message cosmos.staking.v2beta1.GenesisState is not mutable"))
	case "cosmos.staking.v2beta1.GenesisState.exported":
		panic(fmt.Errorf("field exported of message cosmos.staking.v2beta1.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v2beta1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v2beta1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_staking_v2beta1_genesis_proto_init()
	md_LastValidatorPower = File_cosmos_staking_v2beta1_genesis_proto.Messages().ByName("LastValidatorPower")
...
func (x *LastValidatorPower) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v2beta1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_LastValidatorPower) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v2beta1.LastValidatorPower.address":
		return x.Address != ""
	case "cosmos.staking.v2beta1.LastValidatorPower.power":
		return x.Power != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v2beta1.LastValidatorPower"))
		}
		panic(fmt.Errorf("message cosmos.staking.v2beta1.LastValidatorPower does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_LastValidatorPower) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v2beta1.LastValidatorPower does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_LastValidatorPower) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v2beta1.LastValidatorPower.address":
		panic(fmt.Errorf("field address of message cosmos.staking.v2beta1.LastValidatorPower is not mutable"))
	case "cosmos.staking.v2beta1.LastValidatorPower.power":
		panic(fmt.Errorf("field power of message cosmos.staking.v2beta1.LastValidatorPower is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v2beta1.LastValidatorPower"))
		}
...
func (x *fastReflection_LastValidatorPower) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v2beta1.LastValidatorPower", d.FullName()))
	}
	panic("unreachable")
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v2beta1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (*LastValidatorPower) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v2beta1_genesis_proto_rawDescGZIP(), []int{1}
}
...
var File_cosmos_staking_v2beta1_genesis_proto protoreflect.FileDescriptor

var file_cosmos_staking_v2beta1_genesis_proto_rawDesc = []byte{
	0x0a, 0x24, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67,
	0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73,
	...
	0x6b, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x73, 0x74, 0x61,
	...
	0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	...
	,
}

var (
	file_cosmos_staking_v2beta1_genesis_proto_rawDescOnce sync.Once
	file_cosmos_staking_v2beta1_genesis_proto_rawDescData = file_cosmos_staking_v2beta1_genesis_proto_rawDesc
)

func file_cosmos_staking_v2beta1_genesis_proto_rawDescGZIP() []byte {
	file_cosmos_staking_v2beta1_genesis_proto_rawDescOnce.Do(func() {
		file_cosmos_staking_v2beta1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_staking_v2beta1_genesis_proto_rawDescData)
	})
	return file_cosmos_staking_v2beta1_genesis_proto_rawDescData
}

var file_cosmos_staking_v2beta1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cosmos_staking_v2beta1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil),        // 0: cosmos.staking.v2beta1.GenesisState
	(*LastValidatorPower)(nil),  // 1: cosmos.staking.v2beta1.LastValidatorPower
	(*Params)(nil),              // 2: cosmos.staking.v2beta1.Params
	(*ValidatorApproval)(nil),   // 3: cosmos.staking.v2beta1.ValidatorApproval
	(*Validator)(nil),           // 4: cosmos.staking.v2beta1.Validator
	(*Delegation)(nil),          // 5: cosmos.staking.v2beta1.Delegation
	(*UnbondingDelegation)(nil), // 6: cosmos.staking.v2beta1.UnbondingDelegation
	(*Redelegation)(nil),        // 7: cosmos.staking.v2beta1.Redelegation
}
var file_cosmos_staking_v2beta1_genesis_proto_depIdxs = []int32{
	2, // 0: cosmos.staking.v2beta1.GenesisState.params:type_name -> cosmos.staking.v2beta1.Params
	1, // 1: cosmos.staking.v2beta1.GenesisState.last_validator_powers:type_name -> cosmos.staking.v2beta1.LastValidatorPower
	3, // 2: cosmos.staking.v2beta1.GenesisState.validator_approval:type_name -> cosmos.staking.v2beta1.ValidatorApproval
	4, // 3: cosmos.staking.v2beta1.GenesisState.validators:type_name -> cosmos.staking.v2beta1.Validator
	5, // 4: cosmos.staking.v2beta1.GenesisState.delegations:type_name -> cosmos.staking.v2beta1.Delegation
	6, // 5: cosmos.staking.v2beta1.GenesisState.unbonding_delegations:type_name -> cosmos.staking.v2beta1.UnbondingDelegation
	7, // 6: cosmos.staking.v2beta1.GenesisState.redelegations:type_name -> cosmos.staking.v2beta1.Redelegation
...
func init() { file_cosmos_staking_v2beta1_genesis_proto_init() }
func file_cosmos_staking_v2beta1_genesis_proto_init() {
	if File_cosmos_staking_v2beta1_genesis_proto != nil {
		return
	}
	file_cosmos_staking_v2beta1_staking_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_cosmos_staking_v2beta1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_staking_v2beta1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_staking_v2beta1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_staking_v2beta1_genesis_proto_goTypes,
		DependencyIndexes: file_cosmos_staking_v2beta1_genesis_proto_depIdxs,
		MessageInfos:      file_cosmos_staking_v2beta1_genesis_proto_msgTypes,
	}.Build()
	File_cosmos_staking_v2beta1_genesis_proto = out.File
	file_cosmos_staking_v2beta1_genesis_proto_rawDesc = nil
	file_cosmos_staking_v2beta1_genesis_proto_goTypes = nil
	file_cosmos_staking_v2beta1_genesis_proto_depIdxs = nil
}
