...
func init() {
	file_cosmos_staking_v2beta1_authz_proto_init()
	md_StakeAuthorization = File_cosmos_staking_v2beta1_authz_proto.Messages().ByName("StakeAuthorization")
...
func (x *StakeAuthorization) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v2beta1_authz_proto_msgTypes[0]
...
func (x *fastReflection_StakeAuthorization) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v2beta1.StakeAuthorization.max_tokens":
		return x.MaxTokens != nil
	case "cosmos.staking.v2beta1.StakeAuthorization.allow_list":
		if x.Validators == nil {
			return false
	...
	case "cosmos.staking.v2beta1.StakeAuthorization.deny_list":
		if x.Validators == nil {
			return false
	...
	case "cosmos.staking.v2beta1.StakeAuthorization.authorization_type":
		return x.AuthorizationType != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v2beta1.StakeAuthorization"))
		}
		panic(fmt.Errorf("message cosmos.staking.v2beta1.StakeAuthorization does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v2beta1.StakeAuthorization does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v2beta1.StakeAuthorization.authorization_type":
		panic(fmt.Errorf("field authorization_type of message cosmos.staking.v2beta1.StakeAuthorization is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v2beta1.StakeAuthorization"))
		}
...
func (x *fastReflection_StakeAuthorization) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "cosmos.staking.v2beta1.StakeAuthorization.validators":
		if x.Validators == nil {
			return nil
		}
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v2beta1.StakeAuthorization", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_staking_v2beta1_authz_proto_init()
	md_StakeAuthorization_Validators = File_cosmos_staking_v2beta1_authz_proto.Messages().ByName("StakeAuthorization").Messages().ByName("Validators")
...
func (x *StakeAuthorization_Validators) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v2beta1_authz_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_StakeAuthorization_Validators) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v2beta1.StakeAuthorization.Validators.address":
		return len(x.Address) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v2beta1.StakeAuthorization.Validators"))
		}
		panic(fmt.Errorf("message cosmos.staking.v2beta1.StakeAuthorization.Validators does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization_Validators) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v2beta1.StakeAuthorization.Validators does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization_Validators) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v2beta1.StakeAuthorization.Validators", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cosmos/staking/v2beta1/authz.proto
...
func (AuthorizationType) Descriptor() protoreflect.EnumDescriptor {
	return file_cosmos_staking_v2beta1_authz_proto_enumTypes[0].Descriptor()
}

func (AuthorizationType) Type() protoreflect.EnumType {
	return &file_cosmos_staking_v2beta1_authz_proto_enumTypes[0]
}
...
func (AuthorizationType) EnumDescriptor() ([]byte, []int) {
	return file_cosmos_staking_v2beta1_authz_proto_rawDescGZIP(), []int{0}
}
...
type StakeAuthorization struct {
	...
	AuthorizationType AuthorizationType `protobuf:"varint,4,opt,name=authorization_type,json=authorizationType,proto3,enum=cosmos.staking.v2beta1.AuthorizationType" json:"authorization_type,omitempty"`
}
...
func (*StakeAuthorization_Validators) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v2beta1_authz_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_cosmos_staking_v2beta1_authz_proto protoreflect.FileDescriptor

var file_cosmos_staking_v2beta1_authz_proto_rawDesc = []byte{
	0x0a, 0x22, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67,
	0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x73, 0x74, 0x61,
	0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x1a, 0x14, 0x67, 0x6f,
	...
	0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x53, 0x74, 0x61,
	...
	0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x41,
	...
	0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x3b, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67,
	0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x53, 0x58, 0xaa, 0x02, 0x16,
	0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x53, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x56,
	0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0xca, 0x02, 0x16, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5c,
	0x53, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x5c, 0x56, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0xe2,
	...
	0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x3a, 0x3a, 0x56, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_cosmos_staking_v2beta1_authz_proto_rawDescOnce sync.Once
	file_cosmos_staking_v2beta1_authz_proto_rawDescData = file_cosmos_staking_v2beta1_authz_proto_rawDesc
)

func file_cosmos_staking_v2beta1_authz_proto_rawDescGZIP() []byte {
	file_cosmos_staking_v2beta1_authz_proto_rawDescOnce.Do(func() {
		file_cosmos_staking_v2beta1_authz_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_staking_v2beta1_authz_proto_rawDescData)
	})
	return file_cosmos_staking_v2beta1_authz_proto_rawDescData
}

var file_cosmos_staking_v2beta1_authz_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_cosmos_staking_v2beta1_authz_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cosmos_staking_v2beta1_authz_proto_goTypes = []interface{}{
	(AuthorizationType)(0),                // 0: cosmos.staking.v2beta1.AuthorizationType
	(*StakeAuthorization)(nil),            // 1: cosmos.staking.v2beta1.StakeAuthorization
	(*StakeAuthorization_Validators)(nil), // 2: cosmos.staking.v2beta1.StakeAuthorization.Validators
	(*v1beta1.Coin)(nil),                  // 3: cosmos.base.v1beta1.Coin
}
var file_cosmos_staking_v2beta1_authz_proto_depIdxs = []int32{
	3, // 0: cosmos.staking.v2beta1.StakeAuthorization.max_tokens:type_name -> cosmos.base.v1beta1.Coin
	2, // 1: cosmos.staking.v2beta1.StakeAuthorization.allow_list:type_name -> cosmos.staking.v2beta1.StakeAuthorization.Validators
	2, // 2: cosmos.staking.v2beta1.StakeAuthorization.deny_list:type_name -> cosmos.staking.v2beta1.StakeAuthorization.Validators
	0, // 3: cosmos.staking.v2beta1.StakeAuthorization.authorization_type:type_name -> cosmos.staking.v2beta1.AuthorizationType
...
func init() { file_cosmos_staking_v2beta1_authz_proto_init() }
func file_cosmos_staking_v2beta1_authz_proto_init() {
	if File_cosmos_staking_v2beta1_authz_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_staking_v2beta1_authz_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_staking_v2beta1_authz_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_cosmos_staking_v2beta1_authz_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_staking_v2beta1_authz_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_staking_v2beta1_authz_proto_goTypes,
		DependencyIndexes: file_cosmos_staking_v2beta1_authz_proto_depIdxs,
		EnumInfos:         file_cosmos_staking_v2beta1_authz_proto_enumTypes,
		MessageInfos:      file_cosmos_staking_v2beta1_authz_proto_msgTypes,
	}.Build()
	File_cosmos_staking_v2beta1_authz_proto = out.File
	file_cosmos_staking_v2beta1_authz_proto_rawDesc = nil
	file_cosmos_staking_v2beta1_authz_proto_goTypes = nil
	file_cosmos_staking_v2beta1_authz_proto_depIdxs = nil
}
