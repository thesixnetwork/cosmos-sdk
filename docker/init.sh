...
simd genesis add-genesis-account $(simd keys show -a val1 --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 110000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a val2 --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 110000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a val3 --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 110000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a val4 --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 110000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a alice --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 10000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a bob --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 10000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a super-admin --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 10000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}

simd genesis gentx ${VALKEY} 10000000000000stake --chain-id=${CHAIN_ID} --keyring-backend=test --home ${STAKE_HOME}
