...
# Set client config
simd config keyring-backend $KEYRING --home ${STAKE_HOME}
simd config chain-id $CHAINID --home ${STAKE_HOME}
...
# simd gentx val1 1000000000000stake --min-self-delegation="10000000000" --license-mode=true --min-delegation="10000000000" --delegation-increment="10000000000" --max-license=100 --enable-redelegation=false --keyring-backend $KEYRING --chain-id $CHAINID

# Collect genesis tx
simd collect-gentxs --home ${STAKE_HOME}

# Run this to ensure everything worked and that the genesis file is setup correctly
simd validate-genesis --home ${STAKE_HOME}
