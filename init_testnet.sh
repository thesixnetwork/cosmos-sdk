...
## denom stake
simd genesis add-genesis-account $(simd keys show -a val1 --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 11000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a alice --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 1000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a bob --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 1000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
simd genesis add-genesis-account $(simd keys show -a super-admin --keyring-backend ${KEYRING} --home ${STAKE_HOME}) 1000000000000stake --keyring-backend ${KEYRING} --home ${STAKE_HOME}
...
simd genesis gentx val1 1000000000000stake --min-self-delegation="10000000000" --validator-mode=1 --min-delegation="10000000000" --delegation-increment="10000000000" --max-license=100 --enable-redelegation=false --keyring-backend $KEYRING --chain-id $CHAINID --home ${STAKE_HOME}
...
simd start --minimum-gas-prices=1.25stake --rpc.laddr "tcp://0.0.0.0:26657" --home ${STAKE_HOME}